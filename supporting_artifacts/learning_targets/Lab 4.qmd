...
---
## Revision
**This lab was revised before being included in the final portfolio.**
...
#| warning: false
#| include: false
avocados <- read_csv(here::here("supporting_artifacts", "learning_targets", "Data", "avocado.csv"), 
...
**5.Top five metro areas for avocado volume**
...
**7. Show the proportion of Hass avocado sales**
