...
dirtyhousing <- readxl::read_xls(here::here("supporting_artifacts", "extended_learning", 
...
```{r data}
#| warning: false
avocados <- read_csv(here::here("supporting_artifacts", "extended_learning", "avocado.csv"), 
