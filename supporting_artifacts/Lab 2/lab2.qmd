...
#| warning: false
# Code for question 1! 
surveys <- read_csv(here::here("supporting_artifacts", "Lab 2", "surveys.csv"), 
...
The dimensions are 30463 rows by 15 columns.
...
There are 7 number variables, 7 character variables, and 1 date variable.
...
ggplot(data = surveys, 
  ...
  labs(x = "Weight (grams)", y = "Species", title = "Rodent Species") +
  scale_color_manual(values = brewer.pal(n = 8, name = "Dark2")) +
  geom_boxplot(outlier.alpha = 1) +
  theme(legend.position = "none") +
  coord_cartesian(xlim = c(0, 360)) +
  annotate("text", y = 1, x = 325, label = "Neotama") +
  annotate("text", y = 2, x = 325, label = "Chaetodipus") +
  annotate("text", y = 3, x = 325, label = "Peromyscus") +
  annotate("text", y = 4, x = 325, label = "Perognathus") +
  annotate("text", y = 5, x = 325, label = "Reithrodontomys") +
  annotate("text", y = 6, x = 325, label = "Sigmodon") +
  annotate("text", y = 7, x = 325, label = "Onychomys") +
  annotate("text", y = 8, x = 325, label = "Peromyscus") +
  annotate("text", y = 9, x = 325, label = "Reithrodontomys") +
  annotate("text", y = 10, x = 325, label = "Dipodomys") +
  annotate("text", y = 11, x = 325, label = "Dipodomys") +
  annotate("text", y = 12, x = 325, label = "Chaetodipus") +
  annotate("text", y = 13, x = 325, label = "Dipodomys") +
  annotate("text", y = 14, x = 325, label = "Onychomys") 
```
